...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/gamedeck.git

**All changes should be based from the `vNext` branch.**

Push to your fork and [submit a pull request](https://github.com/michaeljolley/gamedeck/compare/) against the `vNext` branch.
